...
- `ALLOW_DATA_URI_IMAGES`: **false** Allow data uri images (`<img src="data:image/png;base64,..."/>`). <!-- alt="" <- This comment exists to hide this text when searching for images missing an alt attribute -->
