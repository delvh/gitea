...
<img src="https://try.gogs.io/img/favicon.png" width="200" height="200">` + // alt="" <- This comment exists to hide this text when searching for images missing an alt attribute
